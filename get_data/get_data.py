...
class GetData:
    ...
    def get_is_run(self, row):
        flag = None
        col = int(excel_data.get_excel_run())
    ...
    def git_method_way(self,row):
        col=int(excel_data.get_excel_request_way())
    ...
    def is_depend(self,row):
        col=int(excel_data.get_excel_data_depend())
        api_data = self.opera_excel.get_cell_value(row, col)
        return api_data
    # 获取请求数据
    def get_api_data(self,row):
        col=int(excel_data.get_excel_data())
        data=self.opera_excel.get_cell_value(row,col)
        return data
    # 获取实际结果
    def write_result(self,row,value):
        col=int(excel_data.get_excel_resuit())
        result=(self.opera_excel.get_cell_value(row,col))
        return result
    # 获取预期结果
    def get_expcet_data(self,row):
        col=int(excel_data.get_excel_expect())
        expect=self.opera_excel.get_cell_value(row,col)
        return expect
    # 获取接口返回数据

    def get_api_return_data(self,row):
        col=int(excel_data.get_excel_aip_data())
        api_data=self.opera_excel.get_cell_value(row,col)
        return api_data

    #获取更换数据字段
    def get_field_depend(self,row):
        col=int(excel_data.get_excel_field_depend())
    ...
    def get_data_depend_new(self,row):
        col=int(excel_data.get_excel_data_depend_new())
